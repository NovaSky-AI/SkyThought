...
log_file="./slurm_8B.log"

command="WANDB_API_KEY=e357e4ac1b5cace6b76e7857c2d97f6a84405006 FORCE_TORCHRUN=1 NNODES=1 NODE_RANK=0 MASTER_PORT=29501 llamafactory-cli train examples/train_full/llama3_full_sft_8B.yaml"

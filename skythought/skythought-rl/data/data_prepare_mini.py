    ...
    for split in ['train']:
        ...
        for data_entry in tqdm(cur_dataset):
            ...
            if args.sky_sys:
                ...
                {
                    "role": "user",
                    "content": data_entry['prompt'][1]['content'].replace("Present the answer in LaTex format: \\boxed{Your answer}", "Please reason step by step and return your final response within \\boxed{{}}.")
                }]

...
def main():
    ...
    parser.add_argument("--dataset", type=str, required=True, choices=["NUMINA", "APPS", "TACO", "MATH500", "AIME", "GPQADiamond", "MMLU", "LiveCodeBench", "GSM8K", "ARC-C"], help="Dataset to process.")
